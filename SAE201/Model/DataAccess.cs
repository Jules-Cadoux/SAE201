...
namespace SAE201.Model
{
    public class DataAccess
    {
        ...
        private readonly string connectionString = "Host=srv-peda-new;Port=5433;Username=allixh;Password=W0sElR;Database=sae201_Nicolas;Options='-c search_path=allixh'";
